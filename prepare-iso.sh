...
function createISO()
{
  if [ $# -eq 2 ] ; then
    ...
    echo
    echo THIS STEP NEEDS TO BE '/Applications/Install\ macOS\ High\ Sierra.app/Contents/Resources/createinstallmedia --volume /Volumes/install_build --applicationpath /Applications/Install\ macOS\ High\ Sierra.app' ON HIGH SIERRA
    echo THAT WOULD REPLACE THE NEXT TWO STEPS AS WELL
